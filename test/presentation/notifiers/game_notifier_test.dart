...
import 'package:tic_tac_toe/data/providers/computer_repository_provider.dart';
...
void main() {
  ...
  test('addComputerMove when endless is on and verify moves get removed', () async {
      final mockComputer = MockComputerRepository();
      when(
      ...
      final container = ProviderContainer.test(
        overrides: [computerRepositoryProvider.overrideWithValue(mockComputer)],
      );
